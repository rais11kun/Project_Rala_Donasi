            ...
            <nav class="navbar navbar-expand-lg bg-primary navbar-dark px-4 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav me-auto">
                        ...
                        <a href="{{ route('donation') }}" class="nav-item nav-link">Donasi</a>
                        <a href="{{ route('event') }}" class="nav-item nav-link">Event</a>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s">
                    <div class="about-img">
                        <img class="img-fluid w-100" src="asset-landing/img/about.jpg" alt="Image">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row g-4">
                    ...
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                <img class="img-fluid w-100" src="asset-landing/img/donation-1.jpg" alt="">
                                <a href="#!"
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.13s">
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                <img class="img-fluid w-100" src="asset-landing/img/donation-2.jpg" alt="">
                                <a href="#!"
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                <img class="img-fluid w-100" src="asset-landing/img/donation-3.jpg" alt="">
                                <a href="#!"
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="event-item h-100 p-4">
                        <img class="img-fluid w-100 mb-4" src="asset-landing/img/event-1.jpg" alt="">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="event-item h-100 p-4">
                        <img class="img-fluid w-100 mb-4" src="asset-landing/img/event-2.jpg" alt="">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="event-item h-100 p-4">
                        <img class="img-fluid w-100 mb-4" src="asset-landing/img/event-3.jpg" alt="">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="team-item d-flex h-100 p-4">
                        <div class="team-detail pe-4">
                            <img class="img-fluid mb-4" src="asset-landing/img/team-1.jpg" alt="">
                            <h3>Boris Johnson</h3>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="team-item d-flex h-100 p-4">
                        <div class="team-detail pe-4">
                            <img class="img-fluid mb-4" src="asset-landing/img/team-2.jpg" alt="">
                            <h3>Donald Pakura</h3>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="team-item d-flex h-100 p-4">
                        <div class="team-detail pe-4">
                            <img class="img-fluid mb-4" src="asset-landing/img/team-3.jpg" alt="">
                    ...
                    <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="asset-landing/img/testimonial-1.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="testimonial-item">
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="asset-landing/img/testimonial-2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial-text pb-5 pb-md-0">
                        ...
                        <div class="testimonial-item">
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="asset-landing/img/testimonial-3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="testimonial-text pb-5 pb-md-0">
        ...
        <div class="container">
            <div class="row g-5 py-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            <img class="img-fluid w-100" src="asset-landing/img/gallery-1.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid w-100" src="asset-landing/img/gallery-2.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid w-100" src="asset-landing/img/gallery-3.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid w-100" src="asset-landing/img/gallery-4.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid w-100" src="asset-landing/img/gallery-5.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid w-100" src="asset-landing/img/gallery-6.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
